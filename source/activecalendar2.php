...
$monthNavLink="<a href=\"".$this->urlNav.$glueNav."orderdate=".$_GET["orderdate"].$glueNav.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."\" >";
$dayLink="<a href=\"../contenido/index2.php?tipo=mes&amp;orderdate=".$day."-".$month."-".$year."&amp;".$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&amp;".$this->dayID."=".$day."\"  target=\"_parent\">".$day."</a>";
//$dayLink="<a href=\"".$this->url.$glue.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&amp;".$this->dayID."=".$day."\">".$day."</a>";
//$fechaordedate="<a href=\"".$this->url.$glue.$this->$ordedate=dayID."-".monthID."-".yeardID."\">"."</a>";
